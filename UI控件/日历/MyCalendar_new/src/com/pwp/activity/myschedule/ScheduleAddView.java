package com.pwp.activity.myschedule;
...
import com.pwp.AppParams;
import com.pwp.activity.MyCalendarHelp;
...
public class ScheduleAddView extends Activity {
	...
	private MyCalendarHelp lc = null;
	...
	private String[] sch_type = AppParams.sch_type;
	private String[] remind = AppParams.remind;
	...
	public ScheduleAddView() {
		lc = new MyCalendarHelp();
		dao = new ScheduleDBHelp(this);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.myschedule_addview);
