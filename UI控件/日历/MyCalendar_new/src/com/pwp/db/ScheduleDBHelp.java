...
import com.pwp.activity.myschedule.model.ScheduleVO;
...
public class ScheduleDBHelp {
	...
	public int save(ScheduleVO scheduleVO) {
		...
		try {
			...
			Cursor cursor = db.rawQuery("select max(scheduleID) from schedule",
					null);
	...
	public ScheduleVO getScheduleByID(int scheduleID) {
		...
		Cursor cursor = db.query("schedule",
				new String[] { "scheduleID", "scheduleTypeID", "remindID",
						"scheduleContent", "scheduleDate" }, "scheduleID=?",
	...
	public ArrayList<ScheduleVO> getAllSchedule() {
		...
		Cursor cursor = db.query("schedule",
				new String[] { "scheduleID", "scheduleTypeID", "remindID",
						"scheduleContent", "scheduleDate" }, null, null, null,
				null, "scheduleID desc");
	...
	public void delete(int scheduleID) {
		...
		try {
			...
			db.delete("scheduletagdate", "scheduleID=?",
					new String[] { String.valueOf(scheduleID) });
			db.setTransactionSuccessful();
		} finally {
			db.endTransaction();
	...
	public void update(ScheduleVO vo) {
		...
		db.update("schedule", values, "scheduleID=?",
	...
	public String[] getScheduleByTagDate(int year, int month, int day) {
		...
		Cursor cursor = db.query("scheduletagdate",
