...
import com.andli.customlistview.adp.FileListAdp;
import com.andli.customlistview.model.FileInfo;
	...
	public FileListView(Context context, String pathname) {
		...
		try {
			...
			folderIcon = BitmapFactory.decodeStream(this.con.getAssets().open(
					"folder32x32.png"));
			back2ParentIcon = BitmapFactory.decodeStream(this.con.getAssets().open(
					"parent32x32.png"));
		} catch (IOException e) {
