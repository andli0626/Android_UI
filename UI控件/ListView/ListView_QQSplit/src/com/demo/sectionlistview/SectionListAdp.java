...
import com.demo.sectionlistview.MainView.StandardArrayAdapter;

/**
 * Adapter for sections.
 */
public class SectionListAdp implements ListAdapter, OnItemClickListener,
	...
	// private final Map<Integer, String> sectionPositions = new
	// LinkedHashMap<Integer, String>();
	// private final Map<Integer, Integer> itemPositions = new
	...
	public SectionListAdp(final LayoutInflater inflater,
	...
	public View getView(final int position, final View convertView,
		...
		if (currentItem != null) {// to set every item's text
			...
			if (getPositionForSection(section) == position) {
				// 显示标题
				view.findViewById(R.id.header_parent).setVisibility(
						view.VISIBLE);
