...
import com.slidingmenu.example.fragments.BirdView;
import com.slidingmenu.example.fragments.BirdGridFragment;
import com.slidingmenu.example.fragments.BirdListMenuFragment;
...
public class ResponsiveUIView extends SlidingFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getSupportFragmentManager().beginTransaction()
				.replace(R.id.menu_frame, new BirdListMenuFragment()).commit();
	...
	public void onBirdPressed(int pos) {
		Intent intent = BirdView.newInstance(this, pos);
