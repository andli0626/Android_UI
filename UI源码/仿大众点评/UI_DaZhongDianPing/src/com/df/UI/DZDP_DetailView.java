 ...
 * 
 * @author lilin
 * @date 2012-12-13 下午3:10:52
 * @annotation POI详情界面
 */
public class DZDP_DetailView extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dzdp_detail);

		LayoutInflater inflater = LayoutInflater.from(this);
		info = (LinearLayout) inflater.inflate(R.layout.dzdp_poidetail, null);
