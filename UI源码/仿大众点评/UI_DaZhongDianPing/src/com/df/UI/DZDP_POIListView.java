...
import com.df.dianping.PoiResultData;
import com.df.dianping.R;
import com.df.dianping.ServerListener;
import com.df.dianping.ServerProxy;
import com.df.widget.PoiListItem;

/**
 * 
 * @author lilin
 * @date 2012-12-13 下午3:12:01
 * @annotation POI列表界面
 */
public class DZDP_POIListView extends Activity implements ServerListener,
		OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dzdp_poilistview);
	...
	private AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() {
		public void onItemClick(AdapterView<?> parent, View v, int position,
			...
			intent.setClass(DZDP_POIListView.this, DZDP_DetailView.class);
	...
	public class PoiResultAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (position == filterData.size() - 1 && !isEnd) {
				loadingView.setVisibility(View.VISIBLE);
				server.sendRequest(DZDP_POIListView.this);
			}
