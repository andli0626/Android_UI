package net.oschina.app.ui.mainview;
...
public class MainView extends Activity {
    ...
    private OnQuickActionClickListener mActionListener = new OnQuickActionClickListener() {
        public void onQuickActionClicked(QuickActionWidget widget, int position) {
    		switch (position) {
    		case 0://用户登录-注销
    			UIHelper.loginOrLogout(MainView.this);
    			break;
    		case 1://我的资料
    			UIHelper.showUserInfo(MainView.this);
    			break;
    		case 2://开源软件
    			UIHelper.showSoftware(MainView.this);
    			break;
    		case 3://搜索
    			UIHelper.showSearch(MainView.this);
    			break;
    		case 4://设置
    			UIHelper.showSetting(MainView.this);
    			break;
    		case 5://退出
    			UIHelper.Exit(MainView.this);
    			break;
    		}
        }
    };
        ...
        lvTweet.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
        		...
        		if(appContext.getLoginUid() == tweet.getAuthorId()) {
					final Handler handler = new Handler(){
						public void handleMessage(Message msg) {
							if(msg.what == 1){
								...
								UIHelper.ToastMessage(MainView.this, res.getErrorMessage());
							}else{
								((AppException)msg.obj).makeToast(MainView.this);
							}
						}
					};
					Thread thread = new Thread(){
					...
					UIHelper.showTweetOptionDialog(MainView.this, thread);
        		} else {
        			UIHelper.showTweetOptionDialog(MainView.this, null);
        		}
				return true;
			}        	
		});
    ...
    {   
        ...
        lvMsg.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {				
				...
				UIHelper.showMessageListOptionDialog(MainView.this, message, thread);
				return true;
			}        	
		});
    ...
    private void initHeadView()
    {
    	...
    	mHeadPub_tweet.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				UIHelper.showTweetPub(MainView.this);
			}
		});
    }
    /**
    ...
    private void initFootBar()
    {
    	...
    	fbSetting.setOnClickListener(new View.OnClickListener() {
    		public void onClick(View v) {    			
    			...
    			UIHelper.showSettingLoginOrLogout(MainView.this, mGrid.getQuickAction(0));
    			mGrid.show(v);
    		}
    	});    	
    }
    ...
    private void setCurPoint(int index)
    {
    	...
    	//处理通知信息
			...
			if(uid == 0){
				UIHelper.showLoginDialog(MainView.this);
				return;
			}    		
	...
	private void foreachUserNotice(){
		...
		final Handler handler = new Handler(){
			public void handleMessage(Message msg) {
				if(msg.what==1){
					UIHelper.sendBroadCast(MainView.this, (Notice)msg.obj);
				}
			...
			public void handleMessage(Message msg) {
				if(msg.what==1 && msg.obj != null){
					...
					if(res.OK() && res.getNotice()!=null){
						UIHelper.sendBroadCast(MainView.this, res.getNotice());
					}
				}else{
					((AppException)msg.obj).makeToast(MainView.this);
				}
