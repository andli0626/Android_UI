package cn.buaa.myweixin.chat;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.List;

import cn.buaa.myweixin.InfoXiaohei;
import cn.buaa.myweixin.R;
import cn.buaa.myweixin.R.id;
import cn.buaa.myweixin.R.layout;
import cn.buaa.myweixin.model.ChatMsg;
 ...
 */
public class ChatView extends Activity implements OnClickListener{
    ...
    public void initData()
    {
    	...
    	mAdapter = new ChatMsgAdp(this, mDataArrays);
    ...
    public void head_xiaohei(View v) {     //标题栏 返回按钮
    	Intent intent = new Intent (ChatView.this,InfoXiaohei.class);			
